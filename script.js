let phrases = [
  { text: 'понять физику ', image: 'https://code.s3.yandex.net/web-code/procrastinate/1.gif' },
  { text: 'сходить на концерт', image: 'https://code.s3.yandex.net/web-code/procrastinate/2.png' },
  ...
  { text: 'смотреть сериал кухня в 100 раз', image: 'https://code.s3.yandex.net/web-code/procrastinate/5.png' },
